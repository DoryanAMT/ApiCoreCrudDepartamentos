...
namespace ApiCoreCrudDepartamentos.Controllers
{
    ...
    public class DepartamentosController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("[action]")]
        public async Task<ActionResult<List<Departamento>>> c()
        {
            return await this.repo.GetDepartamentosAsync();
        }
        [HttpGet]
        [Route("{id}")]
        public async Task<ActionResult<Departamento>> FindDepartamento
            (int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Departamento>> InsertDepartamento
        ...
        //  EL METODO POR DEFECTO DE DELTE RECIBE UN ID
        [HttpDelete("{id}")]
        public async Task<ActionResult> DeleteDepartamento
            (int id)
        {
        ...
        {
            await this.repo.UpdateDepartamentoAsync
                (id, departamento.Nombre, departamento.Localidad);
            return Ok();
        }
